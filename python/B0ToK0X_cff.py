...
BToK0sMuMuPiPiTable = cms.EDProducer(
    ...
    variables=cms.PSet(
        ...
        MuMu_mu1_fired_DoubleMu4_JpsiTrk_Bc  = uint('MuMu_mu1_fired_DoubleMu4_JpsiTrk_Bc'),
        MuMu_mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced  = uint('MuMu_mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced'),
        MuMu_mu1_fired_DoubleMu4_LowMass_Displaced  = uint('MuMu_mu1_fired_DoubleMu4_LowMass_Displaced'),
        MuMu_mu1_fired_DoubleMu4_MuMuTrk_Displaced  = uint('MuMu_mu1_fired_DoubleMu4_MuMuTrk_Displaced'),
        MuMu_mu1_fired_DoubleMu4_3_LowMass   = uint('MuMu_mu1_fired_DoubleMu4_3_LowMass'),
        MuMu_mu2_fired_Dimuon25_Jpsi         = uint('MuMu_mu2_fired_Dimuon25_Jpsi'),
        MuMu_mu2_fired_DoubleMu4_JpsiTrk_Bc  = uint('MuMu_mu2_fired_DoubleMu4_JpsiTrk_Bc'),
        MuMu_mu2_fired_DoubleMu4_JpsiTrkTrk_Displaced  = uint('MuMu_mu2_fired_DoubleMu4_JpsiTrkTrk_Displaced'),
        MuMu_mu2_fired_DoubleMu4_LowMass_Displaced  = uint('MuMu_mu2_fired_DoubleMu4_LowMass_Displaced'),
        MuMu_mu2_fired_DoubleMu4_MuMuTrk_Displaced  = uint('MuMu_mu2_fired_DoubleMu4_MuMuTrk_Displaced'),
        MuMu_mu2_fired_DoubleMu4_3_LowMass  = uint('MuMu_mu2_fired_DoubleMu4_3_LowMass'),
        MuMu_mu1_dr_Dimuon25_Jpsi            = ufloat('MuMu_mu1_dr_Dimuon25_Jpsi'),
        MuMu_mu1_dr_DoubleMu4_JpsiTrk_Bc     = ufloat('MuMu_mu1_dr_DoubleMu4_JpsiTrk_Bc'),
        MuMu_mu1_dr_DoubleMu4_JpsiTrkTrk_Displaced  = ufloat('MuMu_mu1_dr_DoubleMu4_JpsiTrkTrk_Displaced'),
        MuMu_mu1_dr_DoubleMu4_LowMass_Displaced  = ufloat('MuMu_mu1_dr_DoubleMu4_LowMass_Displaced'),
        MuMu_mu1_dr_DoubleMu4_MuMuTrk_Displaced  = ufloat('MuMu_mu1_dr_DoubleMu4_MuMuTrk_Displaced'),
        MuMu_mu1_dr_DoubleMu4_3_LowMass  = ufloat('MuMu_mu1_dr_DoubleMu4_3_LowMass'),
        MuMu_mu2_dr_Dimuon25_Jpsi            = ufloat('MuMu_mu2_dr_Dimuon25_Jpsi'),
        MuMu_mu2_dr_DoubleMu4_JpsiTrk_Bc     = ufloat('MuMu_mu2_dr_DoubleMu4_JpsiTrk_Bc'),
        MuMu_mu2_dr_DoubleMu4_JpsiTrkTrk_Displaced  = ufloat('MuMu_mu2_dr_DoubleMu4_JpsiTrkTrk_Displaced'),
        MuMu_mu2_dr_DoubleMu4_LowMass_Displaced  = ufloat('MuMu_mu2_dr_DoubleMu4_LowMass_Displaced'),
        MuMu_mu2_dr_DoubleMu4_MuMuTrk_Displaced  = ufloat('MuMu_mu2_dr_DoubleMu4_MuMuTrk_Displaced'),
        MuMu_mu2_dr_DoubleMu4_3_LowMass  = ufloat('MuMu_mu2_dr_DoubleMu4_3_LowMass'),
        ...
        PiPi_p1_fired_DoubleMu4_JpsiTrk_Bc = uint('PiPi_p1_fired_DoubleMu4_JpsiTrk_Bc'),
        PiPi_p1_fired_DoubleMu4_JpsiTrkTrk_Displaced = uint('PiPi_p1_fired_DoubleMu4_JpsiTrkTrk_Displaced'),
        PiPi_p1_fired_DoubleMu4_MuMuTrk_Displaced = uint('PiPi_p1_fired_DoubleMu4_MuMuTrk_Displaced'),
        PiPi_p2_fired_DoubleMu4_JpsiTrk_Bc = uint('PiPi_p2_fired_DoubleMu4_JpsiTrk_Bc'),
        PiPi_p2_fired_DoubleMu4_JpsiTrkTrk_Displaced = uint('PiPi_p2_fired_DoubleMu4_JpsiTrkTrk_Displaced'),
        PiPi_p2_fired_DoubleMu4_MuMuTrk_Displaced = uint('PiPi_p2_fired_DoubleMu4_MuMuTrk_Displaced'),
        PiPi_p1_dr_DoubleMu4_JpsiTrk_Bc = ufloat('PiPi_p1_dr_DoubleMu4_JpsiTrk_Bc'),
        PiPi_p1_dr_DoubleMu4_JpsiTrkTrk_Displaced = ufloat('PiPi_p1_dr_DoubleMu4_JpsiTrkTrk_Displaced'),
        PiPi_p1_dr_DoubleMu4_MuMuTrk_Displaced = ufloat('PiPi_p1_dr_DoubleMu4_MuMuTrk_Displaced'),
        PiPi_p2_dr_DoubleMu4_JpsiTrk_Bc = ufloat('PiPi_p2_dr_DoubleMu4_JpsiTrk_Bc'),
        PiPi_p2_dr_DoubleMu4_JpsiTrkTrk_Displaced = ufloat('PiPi_p2_dr_DoubleMu4_JpsiTrkTrk_Displaced'),
        PiPi_p2_dr_DoubleMu4_MuMuTrk_Displaced = ufloat('PiPi_p2_dr_DoubleMu4_MuMuTrk_Displaced'),
        ...
        K0s_matchTrack1_fired_DoubleMu4_JpsiTrk_Bc = uint('K0s_matchTrack1_fired_DoubleMu4_JpsiTrk_Bc'),
        K0s_matchTrack1_fired_DoubleMu4_JpsiTrkTrk_Displaced = uint('K0s_matchTrack1_fired_DoubleMu4_JpsiTrkTrk_Displaced'),
        K0s_matchTrack1_fired_DoubleMu4_MuMuTrk_Displaced = uint('K0s_matchTrack1_fired_DoubleMu4_MuMuTrk_Displaced'),
        K0s_matchTrack2_fired_DoubleMu4_JpsiTrk_Bc = uint('K0s_matchTrack2_fired_DoubleMu4_JpsiTrk_Bc'),
        K0s_matchTrack2_fired_DoubleMu4_JpsiTrkTrk_Displaced = uint('K0s_matchTrack2_fired_DoubleMu4_JpsiTrkTrk_Displaced'),
        K0s_matchTrack2_fired_DoubleMu4_MuMuTrk_Displaced = uint('K0s_matchTrack2_fired_DoubleMu4_MuMuTrk_Displaced'),
    )
)
