...
muonXTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        triggerMatched_dr = Var("userFloat('DR')",float,doc="dr with the matched triggering muon" ),
        triggerMatched_dpt = Var("userFloat('DPT')",float,doc="dpt/pt with the matched triggering muon" ), 
