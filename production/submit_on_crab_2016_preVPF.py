...
config.General.workArea = 'Xnani2016preVPF_%s' % production_tag
...
config.JobType.psetName = '../test/run_nano_2016_preVFP_cfg.py'
...
if __name__ == '__main__':
  ...
  parser.add_argument('-y', '--yaml', default = 'samples_2016preVPF.yml', help = 'File with dataset descriptions')
