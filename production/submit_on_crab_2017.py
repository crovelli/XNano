...
config.General.workArea = 'Xnani2017_%s' % production_tag
...
config.JobType.psetName = '../test/run_nano_2017_cfg.py'
...
if __name__ == '__main__':
  ...
  parser.add_argument('-y', '--yaml', default = 'samples_2017.yml', help = 'File with dataset descriptions')
