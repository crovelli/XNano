...
config.General.workArea = 'Xnani2018_%s' % production_tag
...
config.JobType.psetName = '../test/run_nano_2018_cfg.py'
...
if __name__ == '__main__':
  ...
  parser.add_argument('-y', '--yaml', default = 'samples_2018.yml', help = 'File with dataset descriptions')
