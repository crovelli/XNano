...
globaltag = '106X_dataRun2_v35' if not options.isMC else '106X_mcRun2_asymptotic_v17'
...
if not options.inputFiles:
    options.inputFiles = ['/store/data/Run2016G/Charmonium/MINIAOD/UL2016_MiniAODv2-v1/120000/00BBA883-56D6-664C-97C1-DB56AB25C54A.root'] if not options.isMC else \
                         ['/store/mc/RunIISummer20UL16MiniAODv2/BuToX3872Ks_X3872ToJPsiRho_JPsiToMuMu_RhoToPiPi_TuneCP5_13TeV-pythia8-evtgen/MINIAODSIM/106X_mcRun2_asymptotic_v17-v2/2810000/0C12D2E4-A255-F949-9C1D-6ECF92B672E9.root']
