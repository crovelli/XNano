...
globaltag = '106X_dataRun2_v35' if not options.isMC else '106X_mcRun2_asymptotic_preVFP_v11'
...
if not options.inputFiles:
    options.inputFiles = ['/store/data/Run2016D/Charmonium/MINIAOD/HIPM_UL2016_MiniAODv2-v1/120000/0089BA55-946D-7C4D-976D-E405DF5DD0B4.root'] if not options.isMC else \
                         ['/store/mc/RunIISummer20UL16MiniAODAPVv2/BuToPsi2SKs_Psi2SToJPsiPiPi_JPsiToMuMu_RhoToPiPi_TuneCP5_13TeV-pythia8-evtgen/MINIAODSIM/106X_mcRun2_asymptotic_preVFP_v11-v2/2820000/00BA35AA-7D79-714A-98EC-AAA0EC1C8E08.root']
